...
INSERT INTO car (id, brand_id, model_id, category_id, color, year, car_number, vin, image)
VALUES (1, (SELECT b.id FROM brand b WHERE name = 'Audi'),
        ...
        'BLACK', '2020', '7594AB-7', '1D8GT58KX8W109715', 'audi-a6.jpg'),
       (2, (SELECT b.id FROM brand b WHERE name = 'Audi'),
        ...
        'BLACK', '2021', '7256AC-7', '1GNDS13S282151069', 'audi-a8.jpg'),
       (3, (SELECT b.id FROM brand b WHERE name = 'BMW'),
        ...
        'GREY', '2019', '7234AB-7', '1LNHM94R89G601547', 'bmw-525.jpg'),
       (4, (SELECT b.id FROM brand b WHERE name = 'BMW'),
        ...
        'YELLOW', '2021', '1864CK-7', 'VF9KZXCY6RTXV8781', 'bmw-m5.jpg'),
       (5, (SELECT b.id FROM brand b WHERE name = 'Ferrari'),
        ...
        'RED', '2018', '1326BH-7', 'TRUHGS9W0B3681847', 'ferrari-458.jpg'),
       (6, (SELECT b.id FROM brand b WHERE name = 'Ford'),
        ...
        'RED', '2019', '2632KP-7', 'WAUYJB132AR7P6468', 'ford-mustang.jpg'),
       (7, (SELECT b.id FROM brand b WHERE name = 'Honda'),
        ...
        'BLACK', '2020', '9784HP-7', 'WA14DPLAFH0NW9773', 'honda-crv.jpg'),
       (8, (SELECT b.id FROM brand b WHERE name = 'Honda'),
        ...
        'WHITE', '2020', '1234KL-7', 'SADLDTB0XT02H3163', 'honda-civic.jpg'),
       (9, (SELECT b.id FROM brand b WHERE name = 'Honda'),
        ...
        'BLACK', '2020', '7514BB-7', 'SAJRV6N4MX36E0069', 'honda-accord.jpg'),
       (10, (SELECT b.id FROM brand b WHERE name = 'Kia'),
        ...
        'GREEN', '2022', '7656AB-7', 'SAJKRM7FGLYCV3181', 'kia-ceed.jpg'),
       (11, (SELECT b.id FROM brand b WHERE name = 'Kia'),
        ...
        'WHITE', '2020', '7213AB-7', 'SDB11VRH0JZ9R1430', 'kia-sportage.jpg'),
       (12, (SELECT b.id FROM brand b WHERE name = 'Mercedes'),
        ...
        'GREY', '2021', '4594AB-7', 'SDB94S7XVFFBD1481', 'mercedes-e200.jpg'),
       (13, (SELECT b.id FROM brand b WHERE name = 'Mercedes'),
        ...
        'RED', '2020', '1594AB-7', 'WP0Z4W4SBYEDR6606', 'mercedes-e63amg.jpg'),
       (14, (SELECT b.id FROM brand b WHERE name = 'Mercedes'),
        ...
        'BLACK', '2020', '6594AB-7', 'WP0RR7EBL6J3Y5833', 'mercedes-s300.jpg'),
       (15, (SELECT b.id FROM brand b WHERE name = 'Nissan'),
        ...
        'SILVER', '2018', '5594AB-7', 'WP07R829T68856850', 'nissan-almera.jpg'),
       (16, (SELECT b.id FROM brand b WHERE name = 'Nissan'),
        ...
        'SILVER', '2017', '766HI-7', 'WP1L4B4RFL4NZ4691', 'nissan-navara.jpg'),
       (17, (SELECT b.id FROM brand b WHERE name = 'Porsche'),
        ...
        'RED', '2020', '1603HN-7', 'TW11VF08P9H7U2325', 'porsche-911.jpg'),
       (18, (SELECT b.id FROM brand b WHERE name = 'Porsche'),
        ...
        'BLACK', '2022', '6882PK-7', 'VNKSH5NTSC58M5782', 'porsche-panamera.jpg'),
       (19, (SELECT b.id FROM brand b WHERE name = 'Porsche'),
        ...
        'WHITE', '2021', '9875BN-7', 'SB189VYHTTVK95304', 'porsche-taycan.jpg'),
       (20, (SELECT b.id FROM brand b WHERE name = 'Renault'),
        ...
        'SILVER', '2020', '5452HU-7', 'VNKATDR7VN0DF0135', 'reno-logan.jpg'),
       (21, (SELECT b.id FROM brand b WHERE name = 'Renault'),
        ...
        'WHITE', '2020', '6568JK-7', 'SB1885SDCT2MT2431', 'reno-duster.jpg'),
       (22, (SELECT b.id FROM brand b WHERE name = 'Skoda'),
        ...
        'BLACK', '2022', '9879DS-7', 'VNK3P74XJ20ES4546', 'skoda-rapid.jpg'),
       (23, (SELECT b.id FROM brand b WHERE name = 'Skoda'),
        ...
        'BLACK', '2018', '4656YU-7', 'SB1BDM98EK0114129', 'skoda-superb.jpg'),
       (24, (SELECT b.id FROM brand b WHERE name = 'Tesla'),
        ...
        'RED', '2019', '1324YU-7', 'VNKRE876C4K1K3940', 'tesla-model-s.jpg'),
       (25, (SELECT b.id FROM brand b WHERE name = 'Tesla'),
        ...
        'RED', '2022', '1232UI-7', 'TW11AGAPP2WDR9845', 'tesla-model-x.jpg'),
       (26, (SELECT b.id FROM brand b WHERE name = 'Toyota'),
        ...
        'RED', '2021', '8656KL-7', 'SB1E72SUFKH0X3650', 'toyota-rav4.jpg'),
       (27, (SELECT b.id FROM brand b WHERE name = 'Volkswagen'),
        ...
        'BLACK', '2019', '6566JK-7', 'VNKA5EZM4F58S0785', 'volkswagen-polo.jpg'),
       (28, (SELECT b.id FROM brand b WHERE name = 'Volkswagen'),
        ...
        'SILVER', '2018', '3299KL-7', 'TW1FXJS3P86LA0986', 'volkswagen-passat.jpg'),
       (29, (SELECT b.id FROM brand b WHERE name = 'Volkswagen'),
        ...
        'RED', '2019', '6523LP-7', 'XLE2V9KGMW68Y8297', 'volkswagen-golf.jpg'),
       (30, (SELECT b.id FROM brand b WHERE name = 'Volkswagen'),
        ...
        'BLACK', '2019', '6455KL-7', 'YS21X7GGNX2ZJ1935', 'volkswagen-touareg.jpg');
