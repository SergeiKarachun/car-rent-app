...
VALUES (1, 'ECONOMY', 50),
       ...
       (4, 'BUSINESS', 150),
       (5, 'LUXURY', 200);
SELECT SETVAL('car_id_seq', (SELECT MAX(id) FROM category));
...
VALUES (1, (SELECT b.id FROM brand b WHERE name = 'Audi'),
       ...
       (12, (SELECT b.id FROM brand b WHERE name = 'Mercedes'),
        ...
        'GREY', '2021', '7594AB-7', 'SDB94S7XVFFBD1481'),
...
INSERT INTO rental_time (id, order_id, car_id, start_rental_date, end_rental_date)
VALUES (1, 1, 30,
